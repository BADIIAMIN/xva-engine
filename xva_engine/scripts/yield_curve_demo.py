...
from market_data.simulators.yield_curve_dummy_simulator import (
    YieldCurveDummySimulator, DummyCurveSpec
)
from market_data.sources.yield_curve_csv_source import YieldCurveCsvSource
...
def main():
    ...
    src = YieldCurveCsvSource("dummy_yield_curves.csv")
